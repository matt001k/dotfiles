...
vim.keymap.set('n', '<leader>gn', ':Neogit kind=vsplit<CR>')
vim.keymap.set('n', '<leader>gn<space>', ':Neogit kind=vsplit cwd=')
vim.keymap.set('n', '<leader>gnc', ':Neogit kind=vsplit cwd=%:p:h<CR>')
